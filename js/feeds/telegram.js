async function getTelegramFeed(channel, id) {
  ...
  const telegramUrl = "https://web-production-09ad.up.railway.app/https://rsshub.app/telegram/channel/" + channel;
          ...
          <div class="feed-header d-flex flex-row justify-content-between bg-body-tertiary border-bottom">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                <li onclick="getTelegramFeed('${data[0].feed_options}', ${data[0].id})"><button class="dropdown-item" type="button"><img class="align-text-bottom me-2 svg-icon" src="./img/reload.svg" width="20" height="20" /></button></li>
